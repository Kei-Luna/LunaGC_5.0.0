...
public enum MaterialType {
    ...
    MATERIAL_FIRE_MASTER_AVATAR_TALENT_ITEM(47),
    MATERIAL_RENAME_ITEM(48),
    MATERIAL_GCG_EXCHANGE_ITEM(49),
    MATERIAL_CHEST_BATCH_USE_WITH_GROUP(50),
    MATERIAL_QUEST_EVENT_BOOK(51),
    MATERIAL_RAINBOW_PRINCE_HAND_BOOK(52),
    MATERIAL_PHOTO_DISPLAY_BOOK(53),
    MATERIAL_REMUS_MUSIC_BOX(54),
    MATERIAL_GREATEFESTIVALV2_INVITE(55),
    MATERIAL_PHOTOV5_HAND_BOOK(56),
    MATERIAL_NATLAN_RELATION_A(57),
    MATERIAL_NATLAN_RELATION_B(58),
    MATERIAL_AVATAR_TRACE(59),
    MATERIAL_PHOTOGRAPH_POSE(60),
    MATERIAL_PROFILE_PICTURE(61),
    MATERIAL_GCG_CARD(62),
    MATERIAL_GCG_CARD_FACE(63),
    MATERIAL_GCG_CARD_BACK(64),
    MATERIAL_GCG_FIELD(65);
