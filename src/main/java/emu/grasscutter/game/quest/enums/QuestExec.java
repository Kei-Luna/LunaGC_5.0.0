...
public enum QuestExec implements QuestTrigger {
    ...
    QUEST_EXEC_GRANT_TRIAL_AVATAR_BATCH_AND_LOCK_TEAM_V2(72),
    QUEST_EXEC_UNKNOWN_73(73),
    QUEST_EXEC_GRANT_TRIAL_AVATAR_AND_LOCK_TEAM_V2(74),
    QUEST_EXEC_OPTIONAL_REVIVAL_TEAM(75),
    QUEST_EXEC_UNKNOWN_76(76),
    QUEST_EXEC_LOCK_AVATAR_TEAM_V2(77),
    QUEST_EXEC_UNLOCK_AVATAR_TEAM_V2(78),
    QUEST_EXEC_UNLOCK_MIRROR_AVATAR_TEAM(79),
    QUEST_EXEC_SET_MAP_LAYER_UNLOCK_STATE(80),
    QUEST_EXEC_HIDE_SCENE_POINT(81),
    QUEST_EXEC_UNHIDE_SCENE_POINT(82),
    QUEST_EXEC_SET_IS_GAME_TIME_LOCKED_V2(83),
    QUEST_EXEC_RANDOM_CLOSED_QUEST_VAR(84),
    QUEST_EXEC_REFRESH_WORLD_QUEST_FLOW_GROUP_SUITE(85),
    QUEST_EXEC_UNLOCK_EVENTS_ITEM(86),
    QUEST_EXEC_ADD_ALCHEMY_SIM_CROP(87),
    QUEST_EXEC_SET_IS_DIVEABLE(88),
