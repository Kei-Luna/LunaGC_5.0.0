...
- Download the [Resources](https://github.com/pmagixc/4.7-res), make a new folder called `resources` in the downloaded LunaGC folder and then extract the resources in that new folder.
